...
\TitelDerArbeit{Bundesliga Match Predictions}
\AutorDerArbeit{Max Bernauer, Philipp Dingfelder, Julius Könning}
\Abteilung{Data Exploration}
\Firma{SAP SE, Schaeffler}
\Kurs{WWI20DSB}
\Studienrichtung{Data Science}
\Matrikelnummer{5763624, xxxxxxx, 7305370}
\Studiengangsleiter{Simon Poll}
\WissBetreuer{x}
\FirmenBetreuer{x}
